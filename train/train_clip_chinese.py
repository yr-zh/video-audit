...
class CustomImageDataset(Dataset):
    def __init__(self, file_path, transform=None):
        ...
        """
        self.classes = {'Q-1': 3, 'Q0': 0, 'Q1':1 , 'Q2':2}
        self.data = []
...
def main():
    ...
    # checkpoint = "./models_chinese/clip_finetuned_classifier_epoch5.pth"
    checkpoint = None
    ...
    img_transform = clip_transform()
    

    dataset = CustomImageDataset(file_path='datasets/fine/index_merge.jsonl', transform=None)
    ...
    for epoch in range(num_epochs):
        ...
        for item in tqdm(dataloader):
            ...
            # images = [img_transform(Image.open(i)) for i in image_path]
        ...
        torch.save(model.state_dict(), f"models_chinese/clip_finetuned_classifier_epoch{epoch+1}.pth")

    
    # 保存微调后的模型参数
    torch.save(model.state_dict(), "models_chinese/clip_finetuned_classifier_last.pth")
    print("模型已保存！")
