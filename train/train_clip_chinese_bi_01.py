...
class CustomImageDataset(Dataset):
    def __init__(self, file_path, transform=None):
        ...
        """
        self.classes_dict = {'Q-1': 0, 'Q0': 0, 'Q1':1}
        self.classes = [0, 1]
        self.data = []
...
def main():
    ...
    dataset = CustomImageDataset(file_path='./datasets/fine/index_merge_20250409_01.jsonl', transform=None)
    ...
    ckpt_path = "model_chinese_bi_01_20250409"
