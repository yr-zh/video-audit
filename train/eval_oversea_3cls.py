...
class CustomImageDataset(Dataset):
    def __init__(self, file_path, transform=None):
        ...
        """
        self.classes_dict = {'Q-1': 0, 'Q0': 0, 'Q1':1, 'Q2':2}
        self.classes = [0, 1, 2]
        self.data = []
...
class CLIPClassifier(nn.Module):
    ...
    def forward(self, texts, images, inputs):
        ...
        fused_vector = self.attention(tag_embeddings, text_embeddings, img_embeddings)
...
def main():
    ...
    dataset = CustomImageDataset(file_path='datasets/oversea/index_train_0419.jsonl', transform=None)
