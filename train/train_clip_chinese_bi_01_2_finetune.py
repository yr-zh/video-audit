...
'''
    在raw data训练好的模型基础上，使用fine data进行finetune
'''
...
def main():
    ...
    checkpoint = "./models_chinese_bi_01_2/clip_finetuned_classifier_epoch2.pth"
    # checkpoint = None
    ...
    dataset = CustomImageDataset(file_path='datasets/fine/index_merge_20250409.jsonl', transform=None)
    ...
    ckpt_path = "models_chinese_bi_01_2_finetune"
