...
class CustomImageDataset(Dataset):
    def __init__(self, file_path, transform=None):
        ...
        """
        self.classes_dict = {'Q-1': 0, 'Q0': 1, 'Q1':2, 'Q2':2}
        self.classes = [0, 1, 2]
        self.data = []
...
def train(rank, world_size):
    ...
    dataset = CustomImageDataset(file_path='datasets/fine/index_train_20250517.jsonl', transform=None)
    # dataset = CustomImageDataset(file_path='datasets/chinese/index_train_merge_20250517.jsonl', transform=None)
    ...
    ckpt_path = "models_chinese_bi_01_2_ddp_0517_3cls"
    if rank == 0:
