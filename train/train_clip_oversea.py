...
def main():
    ...
    # checkpoint = "models_chinese_bi_01_2_oversea/clip_finetuned_classifier_epoch1.pth"
    checkpoint = None
    ...
    dataset = CustomImageDataset(file_path='datasets/oversea/index_train_auxiliary.jsonl', transform=None)
    ...
    ckpt_path = "models_chinese_bi_01_2_oversea_ft"
