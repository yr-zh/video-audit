...
def main():
    ...
    for epoch in range(num_epochs):
        ...
        torch.save(model.state_dict(), f"models_chinese_bi_01_2/clip_finetuned_classifier_epoch{epoch+1}.pth")

    
    # 保存微调后的模型参数
    torch.save(model.state_dict(), "models_chinese_bi_01_2/clip_finetuned_classifier_last.pth")
    print("模型已保存！")
