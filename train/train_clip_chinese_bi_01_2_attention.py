...
class CLIPClassifier(nn.Module):
    def __init__(self, clip_model, num_classes):
        ...
        self.attention = AttentionFusion(input_dim=512)
    ...
    def forward(self, inputs):
        ...
        fused_vector_concat = self.attention(text_embedding, image_embedding)
...
def main():
    ...
    ckpt_path = "models_chinese_bi_01_2_attention"
