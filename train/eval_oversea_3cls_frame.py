...
def evaluate(model, dataloader, processor, device):
    ...
    report = classification_report(all_labels, all_preds, labels=[0, 1, 2], target_names=["Class 0", "Class 1", "Class 2"], digits=4)
    print(report)
...
def main():
    ...
    checkpoint = "models_oversea_3cls/clip_finetuned_classifier_epoch3.pth"
    # checkpoint = None
